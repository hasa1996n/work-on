...
public class LendHistory extends javax.swing.JInternalFrame {
   ...
   Connection conn=null;
    ...
    private void initComponents() {
        ...
        tbllendhistory = new javax.swing.JTable();
        ...
        tbllendhistory.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {},
                {},
                {},
        ...
        jScrollPane1.setViewportView(tbllendhistory);
    ...
    private void txtsearshKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtsearshKeyReleased
        try {
            String sql="SELECT `record_no`, `bid`, `i_date`, `r_date`, `mark` FROM `booklend` WHERE mid LIKE '%"+txtsearsh.getText()+"%'";
            pst=(PreparedStatement) conn.prepareStatement(sql);
            rs=pst.executeQuery();
            tbllendhistory.setModel(net.proteanit.sql.DbUtils.resultSetToTableModel(rs));
    ...
    private javax.swing.JTable tbllendhistory;
